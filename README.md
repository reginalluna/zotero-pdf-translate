...
| --- | --- | --- |
| 7.9.9–10.9.9 | [`translate-for-zotero.xpi`](https://github.com/reginalluna/zotero-pdf-translate/releases/download/v1.0.0/translate-for-zotero.xpi) | `strict_min_version: 7.9.9` to `strict_max_version: 10.9.9` |

The package declares support from Zotero 7.9.9 through Zotero 10.9.9, including Zotero 10.

## Install

1. Download [`translate-for-zotero.xpi`](https://github.com/reginalluna/zotero-pdf-translate/releases/download/v1.0.0/translate-for-zotero.xpi).
