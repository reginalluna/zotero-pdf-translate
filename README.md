...
The add-on manifest accepts Zotero versions from `7.9.9` through `10.9.9`, including Zotero 10. This fork publishes builds from [reginalluna/zotero-pdf-translate](https://github.com/reginalluna/zotero-pdf-translate) while retaining the upstream project history and licence.
...
- Download the plugin (.xpi file) from below.
  - [Latest Stable](https://github.com/reginalluna/zotero-pdf-translate/releases/latest)
  - [All Releases](https://github.com/reginalluna/zotero-pdf-translate/releases)
